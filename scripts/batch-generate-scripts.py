#!/usr/bin/env python3
"""
SalesSmartly Batch Script Generator
...
def fetch_llms() -> list:
    ...
    try:
        req = urllib.request.Request(LLMS_URL, headers={"User-Agent": "SalesSmartly-Agent/1.0"})
...
"""
SalesSmartly {action}{api_info['name'].replace("（", "(").replace("）", ")")} 脚本
