...
def main_func(page: int = 1, page_size: int = 20, **kwargs):
    ...
    print(f"📊 Create - End Session")
    print(f"API: /api/v2/end-session")
    print(f"方法：POST")
    print()
    ...
    if 'POST' == 'GET':
        ...
        url = f"{API_BASE_URL}/api/v2/end-session?{query_string}"
        ...
        # POST/PUT 请求
        url = f"{API_BASE_URL}/api/v2/end-session"
...
def main():
    ...
    main_func(session_id=args.session_id, chat_user_id=args.chat_user_id)
