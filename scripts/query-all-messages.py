...
def main_func(page: int = 1, page_size: int = 20, **kwargs):
    ...
    if 'GET' == 'GET':
        ...
        # POST/PUT 请求
        url = f"{API_BASE_URL}/api/v2/get-all-message-list"
...
def main():
    parser = argparse.ArgumentParser(description='Query - Get All Messages 工具')
    ...
    main_func(page=args.page, page_size=args.page_size)
